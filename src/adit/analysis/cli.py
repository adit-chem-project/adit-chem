...
def main(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument("--export", action="store_true",
                    help=L("軌跡を analysis/export/ に書き出します (extxyz / xyz / pdb と、VMD・OVITO・TRAVIS 用の雛形。説明は export_README.txt)",
                           "write the trajectory to analysis/export/ (extxyz / xyz / pdb plus templates for VMD, OVITO and TRAVIS; see export_README.txt)"))
