ADIT 0.0.1 が生成した DFTB+ の計算ディレクトリです (2026-09-12 03:56 (UTC+09:00))

計算の種類: 一点計算 / 元素: C O H / 原子数: 11
計算コード: DFTB+
...
== このディレクトリのファイル ==
  ...
  skf/          Slater-Koster ファイル (セット mio-1-1。DFTB+ が使う、元素の組ごとのパラメータ) と LICENSE、README: C-C.skf, C-H.skf, C-O.skf, H-C.skf, H-H.skf, H-O.skf, LICENSE, O-C.skf, O-H.skf, O-O.skf, README

== 比べる計算の組 ==
  この計算は adsorption の組の adsorbed です (組の説明と式は ../README.txt、ΔE = +1·adsorbed -1·slab -1·molecule)。
  組の中で値が違う条件: 1 項目 (一覧は ../compare.json の differences)
...
== 研究室のクラスタで実行したいとき ==
  ...
  5. 終わったら結果を手元に取り戻します (手元の PC のターミナルで)
       scp -r <ユーザー名>@<クラスタのホスト名>:<クラスタでの作業ディレクトリ>/adsorbed <手元の置き場所>/
     または
       rsync -av <ユーザー名>@<クラスタのホスト名>:<クラスタでの作業ディレクトリ>/adsorbed <手元の置き場所>/
...
== 作成時の記録 ==
  ADIT 0.1.0a1 / Python 3.14.7 / ASE 3.29.0 / 生成 2026-09-19T01:29:57+00:00 (UTC)
  パラメータなどのファイルの SHA-256 (中身から計算する照合用のハッシュ。同じ値なら同じファイル。spec.json の provenance にも同じもの):
    ...
    042957334558349525498a05aaf06933f805680d2d3ee5757800ec849df3351c  skf/C-H.skf
    77bc2c6d41bab506941921e57bbd644c619a8979130788d377f2146767952829  skf/C-O.skf
    439495f6eab744f4f0644f5c0df08e112f6636fd5b08be106a4ea43e9c1b7e2c  skf/H-C.skf
    ...
    7d34e71a15951a1c908dac0a620d5a9111749140a5763bfc0e39365ef4abe0fa  skf/O-C.skf
