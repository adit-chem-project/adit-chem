ADIT 0.0.1 が生成した DFTB+ の計算ディレクトリです (2026-09-12 04:03 (UTC+09:00))

計算の種類: 一点計算 / 元素: C / 原子数: 16
計算コード: DFTB+
...
== フォノンの変位 ==
  1 個の変位のうち 1 番目 (phonopy、超格子 2x2x2、0.01 Å)。力だけを使います。全体は ../README.txt
...
== 研究室のクラスタで実行したいとき ==
  ...
  5. 終わったら結果を手元に取り戻します (手元の PC のターミナルで)
       scp -r <ユーザー名>@<クラスタのホスト名>:<クラスタでの作業ディレクトリ>/disp-001 <手元の置き場所>/
     または
       rsync -av <ユーザー名>@<クラスタのホスト名>:<クラスタでの作業ディレクトリ>/disp-001 <手元の置き場所>/
...
== 作成時の記録 ==
  ADIT 0.1.0a1 / Python 3.14.7 / ASE 3.29.0 / 生成 2026-09-19T01:30:04+00:00 (UTC)
